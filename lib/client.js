...
function sanitizeConfig(input2) {
  ...
  const pickString = (value) => typeof value === "string" && value !== "" ? value : void 0;
...
async function fetchWeather(location, signal) {
  ...
  return {
    ...
    current: {
      ...
      // its documented unit.
      visibility: current.visibility != null ? current.visibility / 1e3 : void 0,
...
function TodayFacts(props) {
  const { items } = props;
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { "data-block": "today", style: { display: "flex", flexWrap: "wrap", gap: "8px 18px", marginTop: 12, fontSize: 12, color: TOKEN.fgMuted }, children: items.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { display: "flex", alignItems: "center", gap: 5 }, children: [
...
function DailyList(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { "data-block": "daily", style: { marginTop: 10 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { children: points.map((point, index) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "3px 2px", borderBottom: index === points.length - 1 ? "none" : `1px solid ${TOKEN.border}`, fontSize: 12.5 }, children: [
...
function WeatherBar(props) {
  const { scope } = props;
  const [config, setConfig] = (0, import_react2.useState)(() => sanitizeConfig(scope.getSnapshot().value));
  ...
  const chipRef = (0, import_react2.useRef)(null);
  ...
  const lastDriftProbeRef = (0, import_react2.useRef)(0);
  ...
  const [driftNotice, setDriftNotice] = (0, import_react2.useState)(null);
  const driftTimerRef = (0, import_react2.useRef)(null);
  const showDrift = (0, import_react2.useCallback)((newName, notify) => {
  ...
  const persistLocation = (0, import_react2.useCallback)((loc) => {
  ...
  const alertsEnabledRef = (0, import_react2.useRef)(effective.alertsEnabled);
  ...
  (0, import_react2.useEffect)(() => {
    const sync = () => setConfig(sanitizeConfig(scope.getSnapshot().value));
    sync();
  ...
  const measurePopover = (0, import_react2.useCallback)(() => {
  ...
  const closePopover = (0, import_react2.useCallback)((restoreFocus) => {
    setOpen(false);
  ...
  (0, import_react2.useEffect)(() => {
    ...
    const samePlace = !bypassCacheRef.current && location !== null && (effective.locationMode === "manual" ? location.source === "manual" && location.latitude === effective.latitude && location.longitude === effective.longitude : location.latitude === effective.autoLatitude && location.longitude === effective.autoLongitude);
    if (samePlace) return;
    let cancelled = false;
      ...
      try {
        ...
        if (effective.locationMode === "manual") {
          ...
          if (cached === null) {
            ...
            if ((effective.autoSource ?? "ip") !== "gps" && Date.now() - lastDriftProbeRef.current >= DRIFT_PROBE_MIN_GAP_MS) {
              lastDriftProbeRef.current = Date.now();
  ...
  (0, import_react2.useEffect)(() => {
    ...
    const id = window.setInterval(probe, 60 * 6e4);
    return () => {
      cancelled = true;
  ...
  (0, import_react2.useEffect)(() => {
    ...
    const alerts2 = evaluateAlerts(data, fmtLocal, windFmtLocal);
  ...
  (0, import_react2.useEffect)(() => {
    ...
    const condition2 = describeCondition(data.current.weatherCode, data.current.isDay);
    const title = `${condition2.emoji} ${tempText(data.current.temperature, effective.units)} ${placeName()} \u2014 ${appTitle.current}`;
  ...
  const visibilityTextValue = cur?.visibility !== void 0 ? `${cur.visibility.toFixed(1)} km` : void 0;
      ...
      "div",
      {
        ...
        children: [
          ...
          status === "ready" && data !== null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8, marginBottom: 10 }, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("button", { type: "button", onClick: () => setTick((n) => n + 1), title: "\u5237\u65B0", "aria-label": "\u5237\u65B0\u5929\u6C14", style: iconButton, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Glyph, { name: "refresh", size: 14 }) })
            ] }),
            stale && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 10, fontSize: 12, lineHeight: "17px", color: BANNER.warning.color, background: BANNER.warning.bg, border: `1px solid ${BANNER.warning.border}`, borderRadius: 10, padding: "6px 10px" }, children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { flex: "1 1 0", minWidth: 0, display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 6 }, children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                  StatChip,
                  {
                    ...
                    label: "\u98CE\u901F",
                    value: windKmhDisplay !== void 0 ? `${Math.round(windKmhDisplay)}` : "--",
                    suffix: windKmhDisplay !== void 0 ? windSuffixLabel : void 0
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatChip, { icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Glyph, { name: "umbrella", size: 13 }), label: "\u4ECA\u65E5\u964D\u6C34", value: `${data.daily[0]?.precipProb ?? 0}%` }),
                /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                  StatChip,
                  {
                    icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Glyph, { name: "wind", size: 13 }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DailyList, { title: "\u672A\u6765 7 \u5929", points: data.daily, fmt }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, marginTop: 10, paddingTop: 8, borderTop: `1px solid ${TOKEN.border}` }, children: [
              ...
              effective.locationMode === "auto" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                "button",
                {
                  type: "button",
                  onClick: () => {
          ...
          status !== "ready" && status !== "error" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { color: TOKEN.fgMuted, textAlign: "center", padding: 20 }, children: status === "locating" ? "\u5B9A\u4F4D\u4E2D\u2026" : "\u5929\u6C14\u52A0\u8F7D\u4E2D\u2026" })
        ]
      }
    ),
    driftNotice !== null && !open && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "div",
      {
        style: {
          position: "absolute",
        ...
        children: [
          "\u{1F4CD} \u7F51\u7EDC\u53D8\u5316\uFF0C\u5DF2\u5207\u6362\u5230 ",
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("b", { children: driftNotice })
        ]
      }
    )
  ] });
...
function WeatherSettingsSection(props) {
  ...
  const [diagBusy, setDiagBusy] = (0, import_react3.useState)(false);
  const [latInput, setLatInput] = (0, import_react3.useState)("");
  const [lonInput, setLonInput] = (0, import_react3.useState)("");
  const ids = (0, import_react3.useId)();
  const effective = config ?? DEFAULT_WEATHER_CONFIG;
  ...
  const prevCoordsRef = (0, import_react3.useRef)({ lat: effective.latitude, lon: effective.longitude });
  (0, import_react3.useEffect)(() => {
  ...
  const commitCoordinate = (kind, text) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { maxWidth: 560, padding: "4px 0 20px", color: FG }, children: [
    ...
    effective.alertsEnabled && typeof Notification !== "undefined" && Notification.permission === "denied" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { color: DANGER, fontSize: 12, margin: "-2px 0 10px 12px" }, children: "\u901A\u77E5\u6743\u9650\u5DF2\u88AB\u6D4F\u89C8\u5668\u62D2\u7EDD\uFF0C\u8BF7\u5728\u7AD9\u70B9\u8BBE\u7F6E\u4E2D\u5141\u8BB8\u540E\u91CD\u65B0\u5F00\u542F\u3002" }),
    ...
    effective.locationMode === "manual" && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Row, { label: "\u57CE\u5E02\u641C\u7D22", labelFor: `${ids}-search`, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { position: "relative", flex: 1 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "input",
          {
            id: `${ids}-search`,
        ...
        searching && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: { position: "absolute", right: 8, top: 7, fontSize: 12, color: MUTED }, children: "\u641C\u7D22\u4E2D\u2026" }),
        suggestions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "div",
          {
            ...
            children: suggestions.map((place) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
              "button",
              {
                type: "button",
                onClick: () => {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Row, { label: "\u7EAC\u5EA6 / \u7ECF\u5EA6", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "input",
          {
            ...
            onKeyDown: (event) => {
              if (event.key === "Enter") commitCoordinate("latitude", event.currentTarget.value);
            },
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "input",
          {
            ...
            onKeyDown: (event) => {
              if (event.key === "Enter") commitCoordinate("longitude", event.currentTarget.value);
            },
            style: { ...input, width: 120 }
          }
        )
    ...
    notice !== null && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { color: DANGER, fontSize: 12.5, marginTop: 8 }, children: notice }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "button",
          {
            ...
            onClick: () => {
              ...
              setDiag(null);
              setDiagBusy(true);
              void runLocationDiagnostics().then(setDiag).catch(() => setNotice("\u5B9A\u4F4D\u8BCA\u65AD\u5931\u8D25\uFF0C\u8BF7\u7A0D\u540E\u91CD\u8BD5")).finally(() => setDiagBusy(false));
            },
            style: inputButton,
