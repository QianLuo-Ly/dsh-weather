...
var WIND_WARN_KMH = 60;
var WIND_DANGER_KMH = 89;
var GUST_WARN_KMH = 89;
var GUST_DANGER_KMH = 118;
var RAIN_TRACE_MMH = 0.25;
var RAIN_MODERATE_MMH = 2.5;
var RAIN_HEAVY_MMH = 7.6;
...
var CLOUD_PARTLY_PCT = 50;
var CLOUD_OVERCAST_PCT = 87.5;
...
function evaluateAlerts(data, fmt, windFmt = (kmh) => `${Math.round(kmh)} km/h`) {
  ...
  if (curSeverity !== "info") {
    ...
    const deluge = rainRate !== void 0 && rainRate >= RAIN_TORRENTIAL_MMH;
