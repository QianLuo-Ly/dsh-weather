...
function WeatherBar(props) {
  ...
  const trendValues = (0, import_react3.useMemo)(
...
function WeatherSettingsSection(props) {
  ...
  const [clockDraft, setClockDraft] = (0, import_react4.useState)({});
  ...
  const dropClockDraft = (0, import_react4.useCallback)((field, expected) => {
    setClockDraft((prev) => {
  ...
  const coordsSeededRef = (0, import_react4.useRef)(false);
  (0, import_react4.useEffect)(() => {
