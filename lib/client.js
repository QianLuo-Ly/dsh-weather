...
var DAY = {
  ...
  96: { label: "\u96F7\u66B4\u4F34\u51B0\u96F9", emoji: "\u{1F329}\uFE0F" },
  99: { label: "\u5F3A\u96F7\u66B4\u4F34\u51B0\u96F9", emoji: "\u{1F329}\uFE0F" }
};
var NIGHT = {
  ...DAY,
...
var LEAD_HOURS = 12;
var HAZARD_CODES = /* @__PURE__ */ new Set([82, 96, 99]);
...
function severityOfCode(code, precipitation, gustKmh) {
  ...
  if (rate !== void 0 && rate >= RAIN_DANGER_MMH) return "danger";
...
function evaluateAlerts(data, fmt, windFmt = (kmh) => `${Math.round(kmh)} km/h`) {
  ...
  if (curSeverity !== "info") {
    ...
    if (hail || gale && THUNDER_CODES.has(code)) {
      ...
      alerts.push(curSeverity === "danger" ? { key: "heavy-rain", level: "danger", title: "\u66B4\u96E8", detail: "\u964D\u96E8\u5F3A\u5EA6\u5927\uFF0C\u6CE8\u610F\u51FA\u884C\u5B89\u5168\u4E0E\u79EF\u6C34" } : { key: "heavy-rain", level: "warning", title: "\u5927\u96E8", detail: "\u96E8\u52BF\u8F83\u5927\uFF0C\u6CE8\u610F\u51FA\u884C\u5B89\u5168" });
    } else if (THUNDER_CODES.has(code)) {
      alerts.push(curSeverity === "danger" ? { key: "thunder", level: "danger", title: "\u96F7\u96E8", detail: "\u96F7\u7535\u4F34\u5F3A\u964D\u96E8\uFF0C\u6CE8\u610F\u9632\u8303" } : { key: "thunder", level: "warning", title: "\u96F7\u9635\u96E8", detail: "\u6709\u96F7\u7535\u6D3B\u52A8\uFF0C\u6CE8\u610F\u907F\u96E8" });
    } else {
...
function WeatherIcon(props) {
  ...
  if (code === 0 || code === 1) {
    ...
    node = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RainLight, {});
  } else if (code === 56 || code === 66) {
    node = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FreezingRain, {});
  } else if (code === 57 || code === 67) {
    node = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FreezingRainHeavy, {});
    ...
    node = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SnowLight, {});
  } else if (code === 73) {
    node = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Snow, {});
  } else if (code === 75) {
    node = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SnowHeavy, {});
  } else if (code === 77) {
    node = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SnowGrains, {});
  } else if (code === 85) {
    node = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Snow, {});
  } else if (code === 86) {
    node = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SnowHeavy, {});
