...
function severityOfCode(code, precipitation, gustKmh) {
  ...
  if (heavyRain) return rate !== void 0 && rate >= SNOW_WARN_MMH ? "warning" : "info";
...
function useWeatherFeed(options) {
  ...
  (0, import_react.useEffect)(() => {
    if (!effective.enabled) return;
    const id = window.setInterval(() => setTick((n) => n + 1), Math.max(REFRESH_RANGE.min, effective.refreshMinutes) * 6e4);
...
function useDailyBrief(options) {
  ...
  const locationRef = (0, import_react.useRef)(location);
...
function TrendChart(props) {
  ...
  const gradientId = (0, import_react3.useId)();
  if (values.length < 2) {
...
function WeatherBar(props) {
  ...
  const barRef = (0, import_react4.useRef)(null);
  const chipRef = (0, import_react4.useRef)(null);
  const popoverRef = (0, import_react4.useRef)(null);
  const popoverId = (0, import_react4.useId)();
  (0, import_react4.useEffect)(() => {
    const sync = () => {
  ...
  const measurePopover = (0, import_react4.useCallback)(() => {
  ...
  const closePopover = (0, import_react4.useCallback)((restoreFocus) => {
    setOpen(false);
  ...
  const alerts = (0, import_react4.useMemo)(
    () => data === null ? [] : evaluateAlerts(data, fmt, (kmh) => windText(kmh, units)),
    [data, units]
  );
  const advice = (0, import_react4.useMemo)(() => data === null ? null : weatherAdvice(data), [data]);
  const trendValues = (0, import_react4.useMemo)(
    () => data?.hourly.map((point) => tempNumber(point.temperature, units)) ?? [],
    [data, units]
  );
  const trendLabels = (0, import_react4.useMemo)(() => data?.hourly.map((point) => hourLabel(point.time)) ?? [], [data]);
...
function WeatherSettingsSection(props) {
  ...
  const [diag, setDiag] = (0, import_react5.useState)(null);
  const [diagBusy, setDiagBusy] = (0, import_react5.useState)(false);
  const [latInput, setLatInput] = (0, import_react5.useState)("");
  const [lonInput, setLonInput] = (0, import_react5.useState)("");
  const [nameInput, setNameInput] = (0, import_react5.useState)("");
  const [refreshInput, setRefreshInput] = (0, import_react5.useState)(DEFAULT_WEATHER_CONFIG.refreshMinutes);
  const [clockDraft, setClockDraft] = (0, import_react5.useState)({});
  const [pendingDeleteId, setPendingDeleteId] = (0, import_react5.useState)(null);
  const [permission, setPermission] = (0, import_react5.useState)(() => typeof Notification !== "undefined" ? Notification.permission : "denied");
  const ids = (0, import_react5.useId)();
  const skipNextSearchRef = (0, import_react5.useRef)(false);
  const searchBoxRef = (0, import_react5.useRef)(null);
  const diagRunRef = (0, import_react5.useRef)(0);
  const effective = config ?? DEFAULT_WEATHER_CONFIG;
  const snapshot = scope.getSnapshot();
  const notify = (0, import_react5.useCallback)((text, kind = "ok") => {
    setNotice({ text, kind });
  }, []);
  const clearNotice = (0, import_react5.useCallback)(() => setNotice(null), []);
  const dropClockDraft = (0, import_react5.useCallback)((field, expected) => {
    setClockDraft((prev) => {
  ...
  const prevCoordsRef = (0, import_react5.useRef)({ lat: effective.latitude, lon: effective.longitude });
  const coordsSeededRef = (0, import_react5.useRef)(false);
  (0, import_react5.useEffect)(() => {
  ...
  const commit = (0, import_react5.useCallback)((fields, clears = []) => {
  ...
  const set = (0, import_react5.useCallback)((field, value) => {
    void commit([[field, value]]);
  }, [commit]);
  const savedCities = useSavedLocations({ scope, effective, onNotice: notify });
  const requestNotificationPermission = (0, import_react5.useCallback)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { maxWidth: 560, padding: "4px 0 20px", color: FG }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { color: MUTED, fontSize: 12, margin: "-2px 0 10px 12px" }, children: "\u5F3A\u964D\u96E8 / \u96F7\u66B4 / \u9AD8\u6E29 / \u5927\u98CE / \u5F3A\u964D\u96EA\u7B49\u786E\u5B9E\u6076\u52A3\u7684\u5929\u6C14\u65F6\u53D1\u9001\u6D4F\u89C8\u5668\u901A\u77E5\u3002" }),
    ...
    effective.briefEnabled && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Row, { label: "\u65E9\u4E0A\u7B80\u62A5\u65F6\u95F4", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Row, { label: "\u665A\u95F4\u7B80\u62A5\u65F6\u95F4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          ClockField,
          {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Row, { label: "\u57CE\u5E02\u641C\u7D22", labelFor: `${ids}-search`, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { ref: searchBoxRef, style: { position: "relative", flex: 1 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "input",
          {
            ...
            "aria-controls": suggestions.length > 0 ? `${ids}-suggestions` : void 0,
            "aria-activedescendant": suggestions.length > 0 ? `${ids}-suggestion-${activeIndex}` : void 0
          }
        ),
