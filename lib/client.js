...
function parseClockTime(value) {
  ...
  return CLOCK_TIME_PATTERN.test(trimmed) ? trimmed : void 0;
}
...
var PLACE_DECIMALS = 3;
function placeKey(latitude, longitude) {
  const fixed = (value) => (value === 0 ? 0 : value).toFixed(PLACE_DECIMALS);
  return `${fixed(latitude)},${fixed(longitude)}`;
}
function locationIdentityKey(latitude, longitude) {
...
function msToNextMinute(settleMs = 20) {
  return 6e4 - Date.now() % 6e4 + settleMs;
}
function rateText(mmPerHour) {
  return `${mmPerHour.toFixed(1)} mm/h`;
}
function compactDistance(kilometres) {
  if (kilometres < 10) {
...
var THUNDER_CODES = /* @__PURE__ */ new Set([95, 96, 99]);
...
var PRECIP_CODES = /* @__PURE__ */ new Set([...RAIN_CODES, ...THUNDER_CODES, ...SNOW_CODES]);
var HEAT_WARN_C = 35;
var HEAT_ORANGE_C = 37;
var HEAT_DANGER_C = 40;
var FROST_C = 0;
var COLD_WARN_C = -8;
var COLD_DANGER_C = -15;
var WIND_WARN_KMH = 62;
var WIND_DANGER_KMH = 118;
var GUST_WARN_KMH = 75;
var GUST_DANGER_KMH = 133;
var RAIN_MODERATE_MMH = 2.5;
var RAIN_HEAVY_MMH = 8;
var RAIN_DELUGE_MMH = 16;
var RAIN_TRACE_MMH = 0.25;
var RAIN_TORRENTIAL_MMH = 20;
var RAIN_EXTREME_MMH = 80;
var DELUGE_24H_MM = 50;
var DOWNPOUR_24H_MM = 100;
var CLOUDBURST_24H_MM = 250;
var DELUGE_12H_MM = 50;
var DELUGE_6H_MM = 50;
var DELUGE_3H_MM = 50;
var DELUGE_RED_3H_MM = 100;
var SNOW_MODERATE_24H_MM = 2.5;
var SNOW_HEAVY_24H_MM = 5;
var SNOWSTORM_24H_MM = 10;
var SNOW_CM_PER_MM_WE = 10;
var FOG_VIS_KM = 1;
var MIST_VIS_KM = 10;
var HAZE_RH_MAX = 80;
var HAZE_SLIGHT_VIS_KM = 5;
var HAZE_MILD_VIS_KM = 3;
var HAZE_MODERATE_VIS_KM = 2;
var DUST_CONCENTRATION_MIN = 50;
var DUST_PM10_FLOOR = 100;
var DUST_PM10_MIN = 150;
var DUST_FINE_RATIO_MAX = 0.5;
var WIND_LEVEL3_KMH = 19;
var DUST_SEVERE_VIS_KM = 0.5;
var DUST_EXTREME_VIS_KM = 0.05;
var CLOUD_CLEAR_PCT = 25;
var CLOUD_PARTLY_PCT = 55;
var CLOUD_OVERCAST_PCT = 85;
var FREEZING_RAIN_CODES = /* @__PURE__ */ new Set([56, 57, 66, 67]);
var RAIN_WARN_MMH = 2;
var SNOW_WARN_MMH = 2;
...
var DAY = {
  ...
  53: { label: "\u7EC6\u96E8", emoji: "\u{1F326}\uFE0F" },
  55: { label: "\u6D53\u6BDB\u6BDB\u96E8", emoji: "\u{1F327}\uFE0F" },
  56: { label: "\u51BB\u6BDB\u6BDB\u96E8", emoji: "\u{1F9CA}" },
  57: { label: "\u5F3A\u51BB\u6BDB\u6BDB\u96E8", emoji: "\u{1F327}\uFE0F" },
  61: { label: "\u5C0F\u96E8", emoji: "\u{1F327}\uFE0F" },
  63: { label: "\u4E2D\u96E8", emoji: "\u{1F327}\uFE0F" },
  65: { label: "\u5927\u96E8", emoji: "\u26C8\uFE0F" },
  66: { label: "\u51BB\u96E8", emoji: "\u{1F9CA}" },
  67: { label: "\u5F3A\u51BB\u96E8", emoji: "\u{1F9CA}" },
  71: { label: "\u5C0F\u96EA", emoji: "\u2744\uFE0F" },
  73: { label: "\u4E2D\u96EA", emoji: "\u{1F328}\uFE0F" },
  75: { label: "\u5927\u96EA", emoji: "\u26C4" },
  77: { label: "\u7C73\u96EA", emoji: "\u{1F9CA}" },
  80: { label: "\u9635\u96E8", emoji: "\u{1F326}\uFE0F" },
  81: { label: "\u5F3A\u9635\u96E8", emoji: "\u{1F327}\uFE0F" },
  82: { label: "\u66B4\u9635\u96E8", emoji: "\u{1F327}\uFE0F" },
  85: { label: "\u9635\u96EA", emoji: "\u2744\uFE0F" },
  86: { label: "\u5F3A\u9635\u96EA", emoji: "\u26C4" },
...
var CONDITION_EMOJIS = [.../* @__PURE__ */ new Set([
...
function weatherAdvice(data) {
  ...
  if (aqi !== void 0 && aqi > AQI_HEAVY) {
    return { icon: "\u{1F637}", text: "\u7A7A\u6C14\u91CD\u5EA6\u6C61\u67D3\uFF0C\u5916\u51FA\u5EFA\u8BAE\u4F69\u6234\u53E3\u7F69" };
  }
...
var visText = (km) => `${compactDistance(km)} \u516C\u91CC`;
...
var GLYPH_EMOJI = {
  "clear-day": "\u2600\uFE0F",
  "clear-night": "\u{1F319}",
  "partly-day": "\u{1F324}\uFE0F",
  "partly-night": "\u2601\uFE0F",
  cloudy: "\u2601\uFE0F",
  fog: "\u{1F32B}\uFE0F",
  drizzle: "\u{1F326}\uFE0F",
  "rain-light": "\u{1F327}\uFE0F",
  rain: "\u{1F327}\uFE0F",
  "rain-heavy": "\u{1F327}\uFE0F",
  "freezing-rain": "\u{1F9CA}",
  "freezing-rain-heavy": "\u{1F9CA}",
  "snow-light": "\u2744\uFE0F",
  snow: "\u{1F328}\uFE0F",
  "snow-heavy": "\u26C4",
  "snow-grains": "\u{1F9CA}",
...
var DESCRIBE_EMOJIS = [...new Set(Object.values(GLYPH_EMOJI))];
function skyEvidenceOfHourly(hour) {
  return {
...
function skyEvidenceOf(current, air) {
  return {
...
function dustDescription(e) {
  const dust = finite(e.dust);
  const pm10 = finite(e.pm10);
  const pm25 = finite(e.pm25);
  const coarse = pm10 !== void 0 && pm10 >= DUST_PM10_MIN && (pm25 === void 0 || pm25 / pm10 < DUST_FINE_RATIO_MAX);
  const dustLead = dust !== void 0 && dust >= DUST_CONCENTRATION_MIN && pm10 !== void 0 && pm10 >= DUST_PM10_FLOOR;
  if (!(dustLead || coarse)) return void 0;
  const humidity = finite(e.humidity);
  if (humidity !== void 0 && humidity >= HAZE_RH_MAX) return void 0;
  const vis = finite(e.visibility);
  let label;
  if (vis !== void 0 && vis < DUST_EXTREME_VIS_KM) label = "\u7279\u5F3A\u6C99\u5C18\u66B4";
  else if (vis !== void 0 && vis < DUST_SEVERE_VIS_KM) label = "\u5F3A\u6C99\u5C18\u66B4";
  else if (vis !== void 0 && vis < FOG_VIS_KM) label = "\u6C99\u5C18\u66B4";
  else if (vis !== void 0 && vis < MIST_VIS_KM) {
    label = e.windSpeed !== void 0 && e.windSpeed > WIND_LEVEL3_KMH ? "\u626C\u6C99" : "\u6D6E\u5C18";
  } else label = "\u6D6E\u5C18";
  const visShown = vis !== void 0 && vis < MIST_VIS_KM;
  const basis = dust !== void 0 ? `\u6C99\u5C18\u6D53\u5EA6 ${Math.round(dust)} \xB5g/m\xB3${visShown ? `\uFF0C\u80FD\u89C1\u5EA6 ${visText(vis)}` : ""}` : `PM10 ${Math.round(pm10 ?? 0)} \xB5g/m\xB3\uFF0C\u7C97\u9897\u7C92\u4E3B\u5BFC`;
  return { glyph: "fog", label, basis, uncertain: false };
}
function describeSky(e) {
  const rate = finite(e.precipitation);
  const code = e.weatherCode ?? -1;
  const showers = finite(e.showers);
  const steady = finite(e.rain);
  const showery = showers !== void 0 && showers > 0 && showers >= (steady ?? 0);
  const snowfall = finite(e.snowfall);
  if (snowfall !== void 0 && snowfall > 0) {
    const basis = rate === void 0 ? "\u63A2\u7A7A\u663E\u793A\u964D\u96EA" : `\u964D\u6C34\u7387 ${rateText(rate)}\uFF08\u5176\u4E2D\u964D\u96EA\uFF09`;
    return { glyph: "snow", label: showery ? "\u9635\u96EA" : "\u964D\u96EA", basis, uncertain: false };
  }
  if (FREEZING_RAIN_CODES.has(code) && rate !== void 0 && rate > 0) {
    ...
    return {
      ...
      basis: `${rateText(rate)}\uFF0C\u6C14\u6E29 ${e.temperature === void 0 ? "\u672A\u77E5" : `${Math.round(e.temperature)}\xB0C`}`,
      uncertain: false
    };
  }
  ...
  if (dust !== void 0) return dust;
  const vis = finite(e.visibility);
  if (vis !== void 0 && vis < MIST_VIS_KM) {
    const humidity = finite(e.humidity);
    if (vis < FOG_VIS_KM) {
...
function rainGrade24h(sumMm) {
  if (sumMm === void 0 || !Number.isFinite(sumMm)) return void 0;
...
function snowGrade24h(snowfallCm) {
  if (snowfallCm === void 0 || !Number.isFinite(snowfallCm) || snowfallCm <= 0) return void 0;
...
function rollingRainSum(hourlyRates, windowHours) {
  if (windowHours <= 0 || hourlyRates.length < windowHours) return void 0;
  let sum = 0;
...
var LEAD_HOURS = 12;
var HAZARD_CODES = /* @__PURE__ */ new Set([82]);
var HAIL_CODES = /* @__PURE__ */ new Set([96, 99]);
function severityOfCode(code, precipitation, gustKmh) {
  ...
  const rate = precipitation !== void 0 && Number.isFinite(precipitation) ? precipitation : void 0;
  const gust = gustKmh !== void 0 && Number.isFinite(gustKmh) ? gustKmh : void 0;
  if (rate !== void 0 && rate >= RAIN_TORRENTIAL_MMH) return "danger";
  if (gust !== void 0 && gust >= GUST_DANGER_KMH) return "danger";
  if (hazard) return "danger";
  if (thunder) return "warning";
  if (heavyRain) return rate !== void 0 && rate >= RAIN_WARN_MMH ? "warning" : "info";
  return rate === void 0 || rate >= SNOW_WARN_MMH ? "warning" : "info";
}
function rainRateNote(rate) {
  return rate === void 0 ? "" : `\uFF08\u964D\u6C34\u7387 ${rateText(rate)}\uFF09`;
}
function thunderEvidenceNote(rate, gustKmh, windFmt) {
  if (rate !== void 0 && rate >= RAIN_TORRENTIAL_MMH) return rainRateNote(rate);
  if (gustKmh !== void 0 && gustKmh >= GUST_DANGER_KMH) return `\uFF08\u9635\u98CE ${windFmt(gustKmh)}\uFF09`;
  return "";
}
function evaluateAlerts(data, fmt, windFmt = (kmh) => `${Math.round(kmh)} km/h`) {
  ...
  const rainRate = Number.isFinite(current.precipitation) ? current.precipitation : void 0;
  ...
  if (windKmh !== void 0 && windKmh >= WIND_DANGER_KMH) {
    alerts.push({ key: "wind", level: "danger", title: "\u72C2\u98CE", detail: `\u98CE\u901F ${windFmt(windKmh)}\uFF0C\u5C3D\u91CF\u51CF\u5C11\u5916\u51FA` });
  } else if (gustKmh !== void 0 && gustKmh >= GUST_DANGER_KMH) {
    alerts.push({ key: "wind", level: "danger", title: "\u72C2\u98CE", detail: `\u9635\u98CE ${windFmt(gustKmh)}\uFF0C\u5C3D\u91CF\u51CF\u5C11\u5916\u51FA` });
  } else if (windKmh !== void 0 && windKmh >= WIND_WARN_KMH || gustKmh !== void 0 && gustKmh >= GUST_WARN_KMH) {
    const sustainedAlert = windKmh !== void 0 && windKmh >= WIND_WARN_KMH;
    const gustAlert = gustKmh !== void 0 && gustKmh >= GUST_WARN_KMH;
    const detail = sustainedAlert && windKmh !== void 0 ? `\u98CE\u901F ${windFmt(windKmh)}${gustKmh !== void 0 ? `\uFF0C\u9635\u98CE ${windFmt(gustKmh)}` : ""}` : `\u9635\u98CE ${windFmt(gustKmh ?? 0)}`;
    alerts.push({ key: "wind", level: "warning", title: gustAlert ? "\u5F3A\u9635\u98CE" : "\u5927\u98CE", detail });
  }
  if (curSeverity !== "info") {
    const code = current.weatherCode;
    const hail = HAIL_CODES.has(code);
    const gale = gustKmh !== void 0 && gustKmh >= GUST_DANGER_KMH;
    const deluge = rainRate !== void 0 && rainRate >= RAIN_DELUGE_MMH;
    if (hail || gale && THUNDER_CODES.has(code)) {
      alerts.push({
        ...
        detail: hail ? `\u5929\u6C14\u7801\u63D0\u793A\u96F7\u96E8${thunderEvidenceNote(rainRate, gustKmh, windFmt)}\uFF0C\u6CE8\u610F\u9632\u8303` : "\u96F7\u96E8\u4F34\u5F3A\u9635\u98CE\uFF0C\u6CE8\u610F\u9632\u8303"
      });
      ...
      alerts.push(curSeverity === "danger" ? { key: "thunder", level: "danger", title: "\u96F7\u96E8", detail: `\u96F7\u7535\u4F34\u5F3A\u964D\u96E8${thunderEvidenceNote(rainRate, gustKmh, windFmt)}\uFF0C\u6CE8\u610F\u9632\u8303` } : { key: "thunder", level: "warning", title: "\u96F7\u9635\u96E8", detail: "\u6709\u96F7\u7535\u6D3B\u52A8\uFF0C\u6CE8\u610F\u907F\u96E8" });
    } else {
  ...
  if (future.length > 0) {
    ...
    for (const h of future) {
      ...
      if (h.temperature !== void 0) {
        heatMaxC = Math.max(heatMaxC, h.temperature);
        coldMinC = Math.min(coldMinC, h.temperature);
      }
      if (h.windSpeed !== void 0) maxWindKmh = Math.max(maxWindKmh ?? h.windSpeed, h.windSpeed);
    }
    ...
    if (heatMaxC >= HEAT_WARN_C && !hasKey("heat")) {
      alerts.push({
        ...
        detail: heatMaxC >= HEAT_ORANGE_C ? `\u672A\u6765 ${LEAD_HOURS} \u5C0F\u65F6\u6700\u9AD8\u53EF\u8FBE ${fmt(heatMaxC)}\uFF0C\u907F\u514D\u5348\u540E\u957F\u65F6\u95F4\u6237\u5916\u6D3B\u52A8` : `\u672A\u6765 ${LEAD_HOURS} \u5C0F\u65F6\u6700\u9AD8\u53EF\u8FBE ${fmt(heatMaxC)}\uFF0C\u6CE8\u610F\u9632\u6691`
      });
    }
    ...
    if (maxWindKmh !== void 0 && maxWindKmh >= WIND_WARN_KMH && !hasKey("wind")) {
      alerts.push({
        key: "wind-soon",
...
var PLACE_FACTOR = 10 ** PLACE_DECIMALS;
...
async function runLocationDiagnostics() {
  ...
  const distance = gpsRaw !== null && ipLoc !== null ? haversineKm(gpsRaw.latitude, gpsRaw.longitude, ipLoc.latitude, ipLoc.longitude) : void 0;
...
var IAQI_LEVELS = [0, 50, 100, 150, 200, 300, 400, 500];
var BANDS = {
...
var O3_ONE_HOUR = { iaqi: IAQI_LEVELS, conc: [0, 160, 200, 300, 400, 800, 1e3, 1200] };
var O3_8H_CEILING = 800;
function iaqiIn(band, concentration) {
  if (!Number.isFinite(concentration) || concentration < 0) return void 0;
  for (let i = 0; i < band.conc.length - 1; i += 1) {
    ...
    if (lo === void 0 || hi === void 0 || iaqiLo === void 0 || iaqiHi === void 0) break;
    if (concentration <= hi) {
...
function computeAqi(input2) {
  const iaqi = {};
  const put = (pollutant, concentration, band) => {
    if (concentration === void 0) return;
    const value = iaqiIn(band ?? BANDS[pollutant], concentration);
    if (value !== void 0) iaqi[pollutant] = value;
  };
  put("pm25", input2.pm25);
  put("pm10", input2.pm10);
  put("so2", input2.so2);
  put("no2", input2.no2);
  put("co", input2.co);
  if (input2.o3_8h !== void 0 && input2.o3_8h <= O3_8H_CEILING) put("o3", input2.o3_8h);
  else put("o3", input2.o3_1h, O3_ONE_HOUR);
  const entries = Object.entries(iaqi);
  ...
  return { aqi, primary: aqi > 50 ? primary : void 0, iaqi };
}
...
function scanRain(steps, elapsedInFirstStep = 0) {
...
var AIR_VARIABLES = "pm10,pm2_5,carbon_monoxide,nitrogen_dioxide,sulphur_dioxide,ozone";
var AIR_CURRENT_VARIABLES = `${AIR_VARIABLES},dust`;
var AIR_TIMEOUT_MS = 8e3;
var AIR_GRACE_MS = 2500;
var AIR_MEAN_HOURS = 24;
var AIR_O3_WINDOW = 8;
var UG_PER_MG = 1e3;
var PRECIP_INTERVAL_FALLBACK_S = 900;
var FORECAST_DAYS = 7;
var HOURLY_STEPS = 24;
...
var mapCurrent = (raw, temperature) => {
  const intervalS = typeof raw.interval === "number" && Number.isFinite(raw.interval) && raw.interval > 0 ? raw.interval : PRECIP_INTERVAL_FALLBACK_S;
  const partRate = (value) => value === null || value === void 0 ? void 0 : value * 3600 / intervalS;
  return {
    temperature,
    apparentTemperature: raw.apparent_temperature ?? temperature,
    humidity: raw.relative_humidity_2m ?? void 0,
    windSpeed: raw.wind_speed_10m ?? void 0,
    weatherCode: raw.weather_code ?? -1,
    isDay: (raw.is_day ?? 1) === 1,
    windDirection: raw.wind_direction_10m ?? void 0,
    windGusts: raw.wind_gusts_10m ?? void 0,
    pressure: raw.surface_pressure ?? void 0,
    cloudCover: raw.cloud_cover ?? void 0,
    // Open-Meteo reports visibility in METRES; the field's contract is km, so convert.
    visibility: raw.visibility === null || raw.visibility === void 0 ? void 0 : raw.visibility / 1e3,
    dewPoint: raw.dew_point_2m ?? void 0,
    precipitation: partRate(raw.precipitation),
    rain: partRate(raw.rain),
    showers: partRate(raw.showers),
    snowfall: raw.snowfall ?? void 0,
    cape: raw.cape ?? void 0,
    liftedIndex: raw.lifted_index ?? void 0,
    freezingLevel: raw.freezing_level_height ?? void 0
  };
};
var mapHourly = (raw, from) => (raw.time ?? []).slice(from, from + HOURLY_STEPS).map((time, index) => ({
  time,
  temperature: raw.temperature_2m?.[from + index] ?? void 0,
  weatherCode: raw.weather_code?.[from + index] ?? -1,
  isDay: (raw.is_day?.[from + index] ?? 1) === 1,
  precipProb: raw.precipitation_probability?.[from + index] ?? void 0,
  windSpeed: raw.wind_speed_10m?.[from + index] ?? void 0,
  ...
  precipitation: raw.precipitation?.[from + index] ?? void 0,
  showers: raw.showers?.[from + index] ?? void 0,
  snowfall: raw.snowfall?.[from + index] ?? void 0,
  cape: raw.cape?.[from + index] ?? void 0
}));
var mapDaily = (raw) => (raw.time ?? []).slice(0, FORECAST_DAYS).map((date, index) => ({
  date,
  weatherCode: raw.weather_code?.[index] ?? -1,
  tempMax: raw.temperature_2m_max?.[index] ?? void 0,
  tempMin: raw.temperature_2m_min?.[index] ?? void 0,
  precipProb: raw.precipitation_probability_max?.[index] ?? void 0,
  precipSum: raw.precipitation_sum?.[index] ?? void 0,
  snowfallSum: raw.snowfall_sum?.[index] ?? void 0
}));
var mapMinutely = (raw, offsetSeconds, nowIso) => {
  const times = raw.time ?? [];
  if (times.length === 0) return {};
  const from = containingGridIndex(times, nowIso);
  const precipitation = raw.precipitation ?? [];
  const steps = times.slice(from, from + MINUTELY_STEPS).map((time, index) => ({
    time,
  ...
  const first = steps[0];
  let elapsed = 0;
  if (first !== void 0 && typeof offsetSeconds === "number" && Number.isFinite(offsetSeconds)) {
    const firstStepInstant = Date.parse(`${first.time}:00Z`) - offsetSeconds * 1e3;
    const since = (Date.now() - firstStepInstant) / 6e4;
...
function scaleToMg(value) {
  return value === void 0 ? void 0 : value / UG_PER_MG;
}
function trailingMean(values, end, hours) {
  const from = end - hours;
  if (from < 0 || end > values.length) return void 0;
  let sum = 0;
  for (let i = from; i < end; i += 1) {
    const value = values[i];
    if (value === null || value === void 0 || !Number.isFinite(value)) return void 0;
    sum += value;
  }
  return sum / hours;
}
function maxRunningMean(values, dayStart, end, window2) {
  let max;
  for (let start = Math.max(dayStart, 0); start + window2 <= end; start += 1) {
    const mean = trailingMean(values, start + window2, window2);
    if (mean !== void 0 && (max === void 0 || mean > max)) max = mean;
  }
  return max;
}
var mapAir = (res) => {
  if (res === null || !res.ok) return void 0;
  const raw = res.json;
  const hourly = raw?.hourly;
  const times = hourly?.time ?? [];
  const end = containingGridIndex(times, raw?.current?.time);
  const isoDate = raw?.current?.time?.slice(0, 10);
  const dayStart = isoDate === void 0 ? 0 : Math.max(0, times.findIndex((time) => time.startsWith(isoDate)));
  const concentrations = {
    ...
    o3_1h: raw?.current?.ozone ?? void 0
  };
  const result = computeAqi(concentrations);
  const air = {
    aqi: result?.aqi,
    primary: result?.primary === void 0 ? void 0 : POLLUTANT_LABEL[result.primary],
  ...
  return air.aqi === void 0 && air.pm25 === void 0 && air.dust === void 0 ? void 0 : air;
};
async function fetchWeather(location, signal) {
  ...
  if (current === void 0 || typeof current.temperature_2m !== "number" || !Number.isFinite(current.temperature_2m)) {
...
async function fetchDayDetail(location, date, signal) {
  ...
  return {
    ...
    hourly: (hourly?.time ?? []).map((time, index) => ({
      ...
      precipitation: hourly?.precipitation?.[index] ?? void 0,
      snowfall: hourly?.snowfall?.[index] ?? void 0
    })),
    sunrise: daily?.sunrise?.[0],
    sunset: daily?.sunset?.[0],
...
// src/client/data/location-match.ts
function dayKey(date) {
  return `${date.getFullYear()}-${pad2(date.getMonth() + 1)}-${pad2(date.getDate())}`;
}
function payloadMatchesLocation(data, location) {
  return data !== null && location !== null && data.location === location;
}

// src/client/shared/units.ts
...
function tempText(celsius, units) {
  return `${Math.round(tempNumber(celsius, units))}${units === "fahrenheit" ? "\xB0F" : "\xB0C"}`;
}
function tempNumber(celsius, units) {
...
var NOTIFY_DEDUPE_MAX = 24;
var TITLE_EMOJIS = [.../* @__PURE__ */ new Set([...CONDITION_EMOJIS, ...DESCRIBE_EMOJIS])];
var TITLE_PREFIX_RE = new RegExp(`^(?:${TITLE_EMOJIS.join("|")}) \\S+ -?\\d+\xB0[CF] .+? \u2014 `);
...
function baseLocationFrom(effective, bypassCache) {
  ...
  if (bypassCache || effective.autoLatitude === void 0 || effective.autoLongitude === void 0) return null;
  return {
    kind: "cached",
    loc: {
      // Preserve verbatim — may already carry a district (区) from a trusted fix.
      name: effective.autoCityName !== void 0 && effective.autoCityName !== "" ? effective.autoCityName : CURRENT_LOCATION_LABEL,
...
function useAutoLocation(options) {
  ...
  const probeDrift = (0, import_react.useCallback)(async (cached, isCancelled) => {
    if (cached.source === "gps") return null;
  ...
  (0, import_react.useEffect)(() => {
    ...
    const samePlace = !bypassCache && location !== null && (effective.locationMode === "manual" ? location.source === "manual" && location.latitude === effective.latitude && location.longitude === effective.longitude : location.source !== "manual" && location.latitude === effective.autoLatitude && location.longitude === effective.autoLongitude);
    if (samePlace) {
      setLocating(false);
      setError(null);
      return;
...
function useWeatherFeed(options) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    }, Math.max(REFRESH_RANGE.min, effective.refreshMinutes) * 6e4);
    const onVisibility = () => {
      if (!document.hidden) setTick((n) => n + 1);
    };
    document.addEventListener("visibilitychange", onVisibility);
...
function writeVerified(scope, fields, clears = []) {
  ...
  const landed = () => {
    ...
    return current !== void 0 && fields.every(([field, value]) => deepEqual(current[field], value)) && clears.every((field) => current[field] === void 0);
  };
...
function useConfigWriter(scope) {
  return (0, import_react.useMemo)(() => {
    ...
    return {
      ...
      verify: (checks) => checks.every(([field, expected]) => deepEqual(fieldValue(field), expected))
    };
  }, [scope]);
}
function useSavedLocations(options) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (pending.length === saved.length && pending.every((entry) => saved.some((current) => current.id === entry.id))) {
...
function useWeatherNotifications(options) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (notifiedAt.current.size >= NOTIFY_DEDUPE_MAX) {
      ...
      if (oldest !== void 0) notifiedAt.current.delete(oldest);
    }
...
function clockMinutes(clock) {
  ...
  if (hours === void 0 || minutes === void 0) return void 0;
  return Number(hours) * 60 + Number(minutes);
}
function useDailyBrief(options) {
  const { effective, data, location, placeName, stale } = options;
  const sentRef = (0, import_react2.useRef)(/* @__PURE__ */ new Set());
  const dataRef = (0, import_react2.useRef)(data);
  dataRef.current = data;
  const staleRef = (0, import_react2.useRef)(stale);
  staleRef.current = stale;
  const locationRef = (0, import_react2.useRef)(location);
  ...
  (0, import_react2.useEffect)(() => {
    ...
    const build = (slot) => {
      ...
      if (day.tempMin === void 0 || day.tempMax === void 0) return null;
      const condition = describeCondition(day.weatherCode, true);
      const rainGrade = day.precipSum === void 0 ? void 0 : rainGrade24h(day.precipSum);
      const label = RAIN_CODES.has(day.weatherCode) && rainGrade !== void 0 && rainGrade !== "\u65E0\u964D\u6C34" && rainGrade !== "\u5FAE\u91CF" ? rainGrade : condition.label;
      const range = `${tempText(day.tempMin, effective.units)} ~ ${tempText(day.tempMax, effective.units)}`;
      const rain = day.precipProb !== void 0 && day.precipProb > 0 ? ` \xB7 \u964D\u6C34 ${day.precipProb}%` : "";
      return {
...
function drop(x, y, length, key) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: `M${x} ${y}v${length}`, stroke: PALETTE.rain }, key);
}
function Drizzle() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
...
function flake(x, y, r, key) {
  const q = r * 0.5;
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_react3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: `M${x} ${y - r}v${r * 2}` }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: `M${x - q} ${y - q}l${r} ${r}` }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: `M${x + q} ${y - q}l${-r} ${r}` })
  ] }, key);
}
function SnowLight() {
...
function SnowHeavy() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    flake(9, 19.4, 2.8, "a"),
    flake(15, 20, 2.8, "b"),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "12", cy: "22.4", r: "1", fill: "currentColor", stroke: "none" })
  ] });
}
function SnowGrains() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: CLOUD_LOW }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "8", cy: "19", r: "1", fill: "currentColor", stroke: "none" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "12", cy: "21", r: "1", fill: "currentColor", stroke: "none" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "16", cy: "19", r: "1", fill: "currentColor", stroke: "none" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "12", cy: "17.5", r: "1", fill: "currentColor", stroke: "none" })
  ] });
}
function FreezingRain() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    drop(8, 19, 3, "a"),
    drop(16, 19, 3, "b"),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "12", cy: "20.5", r: "1.2", fill: "currentColor", stroke: "none" })
  ] });
}
function FreezingRainHeavy() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", { d: CLOUD_LOW }),
    drop(7.5, 19, 3.5, "a"),
    drop(10.5, 18.5, 3.5, "b"),
    drop(13.5, 19, 3.5, "c"),
    drop(16.5, 18.5, 3.5, "d"),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("circle", { cx: "12", cy: "22.6", r: "1.1", fill: "currentColor", stroke: "none" })
  ] });
}
function Thunder() {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
...
var GLYPH_NODES = {
  "clear-day": /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sun, {}),
  "clear-night": /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Moon, {}),
  "partly-day": /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloudSun, {}),
  "partly-night": /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CloudMoon, {}),
  cloudy: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cloud, {}),
  ...
  fog: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Fog, {}),
  drizzle: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Drizzle, {}),
  "rain-light": /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RainLight, {}),
  rain: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Rain, {}),
  "rain-heavy": /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeavyRain, {}),
  "freezing-rain": /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FreezingRain, {}),
  "freezing-rain-heavy": /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FreezingRainHeavy, {}),
  "snow-light": /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SnowLight, {}),
  snow: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Snow, {}),
  "snow-heavy": /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SnowHeavy, {}),
  "snow-grains": /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SnowGrains, {}),
  thunder: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Thunder, {}),
  unknown: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Unknown, {})
};
...
function HourlyStrip(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { "data-block": "hourly", style: { marginTop: 10 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { display: "flex", gap: 6, overflowX: "auto", paddingBottom: 4 }, children: points.map((point) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { flex: "0 0 auto", width: 46, textAlign: "center", background: TOKEN.bgSoft, borderRadius: 10, padding: "5px 2px" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { margin: "2px 0" }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(WeatherIcon, { glyph: describeSky(skyEvidenceOfHourly(point)).glyph, size: 18 }) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontSize: 12.5, fontWeight: 600, ...NUM }, children: point.temperature !== void 0 ? fmt(point.temperature) : "\u2014" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontSize: 10, color: point.precipProb !== void 0 && point.precipProb > 0 ? TOKEN.accent : "transparent", ...NUM }, children: point.precipProb !== void 0 ? `${point.precipProb}%` : "" })
    ] }, point.time)) })
  ] });
}
function DailyList(props) {
  ...
  for (const day of points) {
    if (day.tempMin === void 0 || day.tempMax === void 0) continue;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { "data-block": "daily", style: { marginTop: 10 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { children: points.map((point, index) => {
      ...
      const hasRange = tempMin !== void 0 && tempMax !== void 0;
      const left = tempMin !== void 0 && tempMax !== void 0 ? (tempMin - weekMin) / weekSpan * 100 : 0;
      const width = tempMin !== void 0 && tempMax !== void 0 ? Math.max(8, (tempMax - tempMin) / weekSpan * 100) : 0;
      const row2 = {
        display: "flex",
        alignItems: "center",
        gap: 10,
      ...
      const cells = /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { width: 20, textAlign: "center", flex: "0 0 auto" }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(WeatherIcon, { glyph: glyphForCode(point.weatherCode, true), size: 18 }) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { width: 36, flex: "0 0 auto", textAlign: "right", fontSize: 11, color: point.precipProb !== void 0 && point.precipProb > 0 ? TOKEN.accent : TOKEN.fgMuted, ...NUM }, children: point.precipProb !== void 0 ? `${point.precipProb}%` : "\u2014" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { width: 36, flex: "0 0 auto", textAlign: "right", color: TOKEN.fgMuted, ...NUM }, children: tempMin !== void 0 ? fmt(tempMin) : "\u2014" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { position: "relative", flex: 1, height: 4, borderRadius: 2, background: TOKEN.bgSoft, overflow: "hidden" }, children: hasRange && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          "span",
          {
            style: {
              position: "absolute",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { width: 38, flex: "0 0 auto", textAlign: "right", fontWeight: 600, ...NUM }, children: tempMax !== void 0 ? fmt(tempMax) : "\u2014" })
      ] });
      if (onSelectDay === void 0) {
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: row2, children: cells }, point.date);
      }
      return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "button",
        {
          ...
          style: {
            ...
            margin: 0,
            border: "none",
            borderBottom: row2.borderBottom,
            borderRadius: 6,
            background: "transparent",
            color: "inherit",
            fontFamily: "inherit",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", gap: 6, overflowX: "auto", paddingBottom: 4, marginTop: 8 }, children: [
      ...
      detail.hourly.map((point) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontSize: 11, color: TOKEN.fgMuted, ...NUM }, children: hourLabel(point.time) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { margin: "2px 0", minHeight: 18 }, children: point.weatherCode !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(WeatherIcon, { glyph: describeSky(skyEvidenceOfHourly(point)).glyph, size: 18 }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { fontSize: 12, color: TOKEN.fgMuted }, children: "\u2014" }) }),
...
function TrendChart(props) {
  ...
  const gradientId = (0, import_react4.useId)();
  if (values.length < 2) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { style: { fontSize: 12, color: TOKEN.fgMuted }, children: "\u6570\u636E\u4E0D\u8DB3" });
  }
...
var UNGRADED_TOTALS = /* @__PURE__ */ new Set(["\u5FAE\u91CF", "\u65E0\u964D\u6C34"]);
function LiveClock() {
  const [now, setNow] = (0, import_react5.useState)(() => /* @__PURE__ */ new Date());
...
function WeatherBar(props) {
  const { scope } = props;
  const [config, setConfig] = (0, import_react5.useState)(() => sanitizeConfig(scope.getSnapshot().value));
  const [open, setOpen] = (0, import_react5.useState)(false);
  const [pop, setPop] = (0, import_react5.useState)(null);
  const barRef = (0, import_react5.useRef)(null);
  const chipRef = (0, import_react5.useRef)(null);
  const popoverRef = (0, import_react5.useRef)(null);
  const popoverId = (0, import_react5.useId)();
  (0, import_react5.useEffect)(() => {
    const sync = () => {
  ...
  const measurePopover = (0, import_react5.useCallback)(() => {
  ...
  const closePopover = (0, import_react5.useCallback)((restoreFocus) => {
    setOpen(false);
  ...
  const alerts = (0, import_react5.useMemo)(
    () => data === null ? [] : evaluateAlerts(data, fmt, (kmh) => windText(kmh, units)),
    [data, units]
  );
  const advice = (0, import_react5.useMemo)(() => data === null ? null : weatherAdvice(data), [data]);
  const trend = (0, import_react5.useMemo)(() => {
    const values = [];
    const labels = [];
    for (const point of data?.hourly ?? []) {
      if (point.temperature === void 0) continue;
  ...
  const barIcon = showTemp ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(WeatherIcon, { glyph: condition?.glyph ?? "unknown", size: 17 }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Glyph, { name: "pin", size: 15 });
  const chipTitle = [
    name,
  ...
  const visibilityTextValue = cur?.visibility !== void 0 ? `${compactDistance(cur.visibility)} km` : void 0;
  const cloudTextValue = cur?.cloudCover !== void 0 ? pctText(cur.cloudCover) : void 0;
  const rainTotal = data?.daily[0]?.precipSum;
  const rainGrade = rainGrade24h(rainTotal);
  const rainTotalText = rainTotal !== void 0 && rainTotal >= 0.05 ? `${rainTotal.toFixed(1)} mm${rainGrade !== void 0 && !UNGRADED_TOTALS.has(rainGrade) ? ` \xB7 ${rainGrade}` : ""}` : void 0;
  const snowTotal = data?.daily[0]?.snowfallSum;
  const snowGrade = snowGrade24h(snowTotal);
  const snowTotalText = snowTotal !== void 0 && snowTotal > 0 ? `${snowTotal.toFixed(1)} cm${snowGrade !== void 0 && !UNGRADED_TOTALS.has(snowGrade) ? ` \xB7 ${snowGrade}` : ""}` : void 0;
  ...
  if (data?.uvIndexMax !== void 0) todayItems.push(fact("sun", `UV \u5CF0\u503C ${Math.round(data.uvIndexMax)} ${uvLevel(data.uvIndexMax)}`));
  ...
  if (snowTotalText !== void 0) todayItems.push(fact(void 0, `\u4ECA\u65E5\u964D\u96EA ${snowTotalText}`));
    ...
    open && pop !== null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "div",
      {
        ...
        children: [
          ...
          toast !== null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { role: "status", "aria-live": "polite", style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 10, fontSize: 12.5, color: TOKEN.fg, background: TOKEN.bgSoft, border: `1px solid ${TOKEN.accent}`, borderRadius: 10, padding: "6px 10px" }, children: [
            "\u{1F4CD} ",
          ...
          saved.saved.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { role: "group", "aria-label": "\u5207\u6362\u57CE\u5E02", style: { display: "flex", gap: 6, overflowX: "auto", paddingBottom: 6, marginBottom: 8 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
              "button",
              {
                ...
                children: CURRENT_LOCATION_LABEL
              }
            ),
          ...
          status === "ready" && data !== null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
            day.date !== null ? day.error !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { marginBottom: 10 }, children: [
            ...
            ] }) : day.detail !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DayDetailPanel, { detail: day.detail, units, onBack: day.close }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { color: TOKEN.fgMuted, textAlign: "center", padding: 20 }, children: "\u52A0\u8F7D\u5F53\u65E5\u8BE6\u60C5\u2026" }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { "data-block": "hero-stats", style: { display: "flex", alignItems: "center", gap: 18, marginTop: 4 }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { flex: "0 0 auto", display: "flex", alignItems: "center", gap: 12 }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { flex: "0 0 auto", display: "flex", alignItems: "center", justifyContent: "center", width: 58, height: 58, borderRadius: 16, background: TOKEN.bgSoft, border: `1px solid ${TOKEN.border}` }, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(WeatherIcon, { glyph: condition?.glyph ?? "unknown", size: 36 }) }),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { minWidth: 0 }, children: [
                    ...
                    condition?.basis !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: basisLine, children: [
                      condition.uncertain ? "\u6A21\u5F0F\u63A8\u65AD" : "\u4F9D\u636E",
                      " \xB7 ",
                      condition.basis
                    ] })
                  ] })
                ...
                /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { flex: "1 1 0", minWidth: 0, display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 6 }, children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                    StatChip,
                    {
                      ...
                      label: "\u6E7F\u5EA6",
                      value: cur?.humidity !== void 0 ? pctText(cur.humidity) : "--"
                    }
                  ),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                    StatChip,
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StatChip, { icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Glyph, { name: "umbrella", size: 13 }), label: "\u4ECA\u65E5\u964D\u6C34", value: todayPrecipProb !== void 0 ? `${todayPrecipProb}%` : "--" }),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                    StatChip,
                    {
                      icon: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Glyph, { name: "wind", size: 13 }),
...
var basisLine = { fontSize: 11, lineHeight: "15px", color: TOKEN.fgMuted, opacity: 0.85, marginTop: 2 };
var clockSpan = {
  flex: "0 0 auto",
  fontSize: 14,
  lineHeight: "20px",
...
// src/client/settings/WeatherSettings.tsx
var import_react14 = require("react");

// src/client/settings/brief.tsx
var import_react7 = require("react");

// src/client/settings/shared.tsx
...
var CLOCK_HOURS = Array.from({ length: 24 }, (_, index) => pad2(index));
var CLOCK_MINUTES = Array.from({ length: 12 }, (_, index) => pad2(index * 5));
function ClockField(props) {
  ...
  const commit = (nextHour, nextMinute) => onCommit(`${nextHour}:${nextMinute}`);
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: clockField, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      "select",
      {
        ...
        style: clockSelect,
        children: CLOCK_HOURS.map((option) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: option, children: option }, option))
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { style: { color: MUTED, fontSize: 13 }, children: ":" }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      "select",
      {
        id: `${id}-minute`,
        ...
        style: clockSelect,
        children: minutes.map((option) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: option, children: option }, option))
      }
    )
  ] });
}
...
function useNotificationPermission() {
  const [permission, setPermission] = (0, import_react6.useState)(() => typeof Notification !== "undefined" ? Notification.permission : "denied");
...
function BriefSection(props) {
  ...
  const ids = (0, import_react7.useId)();
  const [clockDraft, setClockDraft] = (0, import_react7.useState)({});
  const dropClockDraft = (0, import_react7.useCallback)((field, expected) => {
    setClockDraft((prev) => {
      if (prev[field] === void 0 || expected !== void 0 && prev[field] !== expected) return prev;
      const next = { ...prev };
      delete next[field];
      return next;
    });
  ...
  (0, import_react7.useEffect)(() => {
    setClockDraft((prev) => {
      const next = {};
      if (prev.briefMorning !== void 0 && prev.briefMorning !== effective.briefMorning) {
        next.briefMorning = prev.briefMorning;
      }
      if (prev.briefEvening !== void 0 && prev.briefEvening !== effective.briefEvening) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Row, { label: "\u6BCF\u65E5\u5929\u6C14\u7B80\u62A5", labelFor: `${ids}-brief`, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      "input",
      {
        id: `${ids}-brief`,
        type: "checkbox",
    ...
    effective.briefEnabled && permissionHint !== null && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { color: permission === "denied" ? DANGER : MUTED, fontSize: 12, margin: "-2px 0 10px 12px" }, children: permissionHint }),
    effective.briefEnabled && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Row, { label: "\u65E9\u4E0A\u7B80\u62A5\u65F6\u95F4", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { color: MUTED, fontSize: 12, whiteSpace: "nowrap" }, children: "\u63A8\u9001\u4ECA\u65E5\u5929\u6C14" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Row, { label: "\u665A\u95F4\u7B80\u62A5\u65F6\u95F4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
          ClockField,
          {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: { color: MUTED, fontSize: 12, whiteSpace: "nowrap" }, children: "\u63A8\u9001\u660E\u65E5\u5929\u6C14" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { color: MUTED, fontSize: 12, margin: "-2px 0 10px 12px" }, children: "\u5230\u70B9\u540E\u901A\u8FC7\u6D4F\u89C8\u5668\u901A\u77E5\u63A8\u9001\uFF08\u6309\u672C\u673A\u65F6\u95F4\uFF0C\u6700\u591A\u8865\u53D1 2 \u5C0F\u65F6\uFF09\uFF1A\u65E9\u4E0A\uFF1D\u4ECA\u65E5\u6700\u9AD8/\u6700\u4F4E\u4E0E\u964D\u6C34\u6982\u7387\uFF0C\u665A\u4E0A\uFF1D\u660E\u65E5\u6982\u51B5\u3002" })
  ] });
}

// src/client/settings/diagnostics.tsx
...
function DiagnosticsSection(props) {
  ...
  const [diag, setDiag] = (0, import_react8.useState)(null);
  const [diagBusy, setDiagBusy] = (0, import_react8.useState)(false);
  const diagRunRef = (0, import_react8.useRef)(0);
  (0, import_react8.useEffect)(() => () => {
    diagRunRef.current += 1;
  }, []);
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { marginTop: 20, fontSize: 12, lineHeight: "19px", color: MUTED, background: BG_ROW, border: `1px solid ${BORDER}`, borderRadius: 10, padding: 12 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8, marginBottom: 6 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("span", { style: { fontWeight: 600, color: FG }, children: "\u5B9A\u4F4D\u8BCA\u65AD" }),
    ...
    diag !== null ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
        "\u6D4F\u89C8\u5668 GPS\uFF1A",
      ...
      diag.gpsIpDistanceKm !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { children: [
        "GPS \u2194 IP \u8DDD\u79BB\uFF1A",
    ...
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { children: '\u70B9\u51FB"\u91CD\u65B0\u68C0\u6D4B"\u67E5\u770B GPS / IP \u5404\u81EA\u7684\u539F\u59CB\u7ED3\u679C\u3002' })
  ] });
}

// src/client/settings/location.tsx
var import_react11 = require("react");

// src/client/settings/city-search.tsx
...
function CitySearchField(props) {
  ...
  const [searchFailed, setSearchFailed] = (0, import_react9.useState)(false);
  const [activeIndex, setActiveIndex] = (0, import_react9.useState)(0);
  const skipNextSearchRef = (0, import_react9.useRef)(false);
  const searchBoxRef = (0, import_react9.useRef)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Row, { label: "\u57CE\u5E02\u641C\u7D22", labelFor: `${idPrefix}-search`, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { ref: searchBoxRef, style: { position: "relative", flex: 1 }, children: [
      ...
      "input",
      {
        ...
        onKeyDown: (event) => {
          ...
          if (event.key === "ArrowDown") {
            ...
            if (chosen !== void 0) pickPlace(chosen);
          }
        },
        style: { ...input, paddingRight: searching ? 72 : void 0 },
        "aria-label": "\u641C\u7D22\u57CE\u5E02",
        "aria-expanded": suggestions.length > 0,
        "aria-controls": suggestions.length > 0 ? `${idPrefix}-suggestions` : void 0,
        "aria-activedescendant": suggestions.length > 0 ? `${idPrefix}-suggestion-${activeIndex}` : void 0
      }
    ),
    searching && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: searchingBadge, children: "\u641C\u7D22\u4E2D\u2026" }),
    searchFailed && !searching && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { role: "status", style: { marginTop: 4, fontSize: 12, color: DANGER }, children: "\u57CE\u5E02\u641C\u7D22\u5931\u8D25\uFF0C\u8BF7\u68C0\u67E5\u7F51\u7EDC\u540E\u91CD\u8BD5" }),
    suggestions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      "div",
      {
        ...
        children: suggestions.map((place, index) => {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
                  "button",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: suggestionPin, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Glyph, { name: "pin", size: 14 }) }),
                      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { style: suggestionLines, children: [
                        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: suggestionName, children: place.name }),
                        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { style: suggestionCoords, children: [
...
// src/client/settings/saved-cities.tsx
var import_react10 = require("react");
var import_jsx_runtime9 = require("react/jsx-runtime");
function SavedCitiesList(props) {
  const { savedCities } = props;
  const [pendingDeleteId, setPendingDeleteId] = (0, import_react10.useState)(null);
  const atSavedLimit = savedCities.saved.length >= MAX_SAVED_LOCATIONS;
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { padding: "10px 12px", marginBottom: 8, background: BG_ROW, borderRadius: 10 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: { fontSize: 13 }, children: [
        "\u6536\u85CF\u57CE\u5E02\uFF08",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        "button",
        {
          ...
          children: `\uFF0B \u6536\u85CF${CURRENT_LOCATION_LABEL}`
        }
      )
    ] }),
    savedCities.saved.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: { color: MUTED, fontSize: 12 }, children: `\u8FD8\u6CA1\u6709\u6536\u85CF\u57CE\u5E02\u2014\u2014\u641C\u7D22\u57CE\u5E02\u540E\u70B9 \u2606 \u6536\u85CF\uFF0C\u6216\u6536\u85CF${CURRENT_LOCATION_LABEL}\u3002` }) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: savedCities.saved.map((place) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: { flex: 1, minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: 13 }, children: [
              place.name,
              /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("span", { style: { color: MUTED, fontSize: 12 }, children: [
                "\u3000",
            ...
            active && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { "aria-current": "true", style: { fontSize: 11, color: ACCENT, border: `1px solid ${ACCENT}`, borderRadius: 6, padding: "0 5px", whiteSpace: "nowrap" }, children: "\u5F53\u524D" }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
              "button",
              {
                type: "button",
...
function LocationSection(props) {
  ...
  const ids = (0, import_react11.useId)();
  const [latInput, setLatInput] = (0, import_react11.useState)("");
  const [lonInput, setLonInput] = (0, import_react11.useState)("");
  const [nameInput, setNameInput] = (0, import_react11.useState)("");
  const clearNotice = () => setNotice(null);
  const prevCoordsRef = (0, import_react11.useRef)({ lat: effective.latitude, lon: effective.longitude });
  const coordsSeededRef = (0, import_react11.useRef)(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Row, { label: "\u5B9A\u4F4D\u65B9\u5F0F", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { display: "flex", gap: 14 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("label", { style: radioLabel, children: [
    ...
    effective.locationMode === "manual" && /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(CitySearchField, { effective, savedCities, onEdit: clearNotice, idPrefix: ids }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Row, { label: "\u7EAC\u5EA6 / \u7ECF\u5EA6", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { display: "flex", gap: 8, alignItems: "center" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "input",
          {
            type: "number",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { style: { color: MUTED }, children: "/" }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "input",
          {
            type: "number",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(Row, { label: "\u663E\u793A\u540D\u79F0", labelFor: `${ids}-cityname`, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        "input",
        {
          id: `${ids}-cityname`,
          type: "text",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SavedCitiesList, { savedCities })
  ] });
}

// src/client/settings/toggles.tsx
var import_react12 = require("react");
var import_jsx_runtime11 = require("react/jsx-runtime");
function TogglesSection(props) {
  const { effective, set, permission, onRequestPermission } = props;
  const ids = (0, import_react12.useId)();
  const permissionHint = permission === "denied" ? "\u901A\u77E5\u6743\u9650\u5DF2\u88AB\u6D4F\u89C8\u5668\u62D2\u7EDD\uFF0C\u8BF7\u5728\u7AD9\u70B9\u8BBE\u7F6E\u4E2D\u5141\u8BB8\u540E\u91CD\u65B0\u5F00\u542F\u3002" : permission === "default" ? "\u6D4F\u89C8\u5668\u901A\u77E5\u5C1A\u672A\u6388\u6743\u2014\u2014\u5F00\u542F\u65F6\u8BF7\u5141\u8BB8\uFF0C\u5426\u5219\u63D0\u9192\u4E0E\u7B80\u62A5\u4E0D\u4F1A\u63A8\u9001\u3002" : null;
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Row, { label: "\u663E\u793A\u5929\u6C14\u680F", labelFor: `${ids}-enabled`, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      "input",
      {
        id: `${ids}-enabled`,
        type: "checkbox",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Row, { label: "\u6076\u52A3\u5929\u6C14\u63D0\u9192", labelFor: `${ids}-alerts`, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
      "input",
      {
        id: `${ids}-alerts`,
        type: "checkbox",
    ...
    effective.alertsEnabled && permissionHint !== null && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { style: { color: permission === "denied" ? DANGER : MUTED, fontSize: 12, margin: "-2px 0 10px 12px" }, children: permissionHint }),
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { style: { color: MUTED, fontSize: 12, margin: "-2px 0 10px 12px" }, children: "\u5F3A\u964D\u96E8 / \u96F7\u66B4 / \u9AD8\u6E29 / \u5927\u98CE / \u5F3A\u964D\u96EA\u7B49\u786E\u5B9E\u6076\u52A3\u7684\u5929\u6C14\u65F6\u53D1\u9001\u6D4F\u89C8\u5668\u901A\u77E5\u3002" })
  ] });
}

// src/client/settings/units.tsx
var import_react13 = require("react");
var import_jsx_runtime12 = require("react/jsx-runtime");
var REFRESH_KEY_COMMIT_DELAY_MS = 400;
function UnitsSection(props) {
  const { effective, set } = props;
  const ids = (0, import_react13.useId)();
  const [refreshInput, setRefreshInput] = (0, import_react13.useState)(effective.refreshMinutes);
  const commitTimerRef = (0, import_react13.useRef)(null);
  (0, import_react13.useEffect)(() => {
    setRefreshInput(effective.refreshMinutes);
  }, [effective.refreshMinutes]);
  const cancelScheduledCommit = (0, import_react13.useCallback)(() => {
    if (commitTimerRef.current !== null) {
      window.clearTimeout(commitTimerRef.current);
      commitTimerRef.current = null;
    }
  }, []);
  const commitRefresh = (0, import_react13.useCallback)(() => {
  ...
  const scheduleCommit = (0, import_react13.useCallback)(() => {
    cancelScheduledCommit();
  ...
  (0, import_react13.useEffect)(() => cancelScheduledCommit, [cancelScheduledCommit]);
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Row, { label: "\u6E29\u5EA6\u5355\u4F4D", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { display: "flex", gap: 14 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("label", { style: radioLabel, children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("input", { type: "radio", name: "dsh-weather-units", checked: effective.units === "celsius", onChange: () => set("units", "celsius") }),
        "\u6444\u6C0F \xB0C"
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("label", { style: radioLabel, children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("input", { type: "radio", name: "dsh-weather-units", checked: effective.units === "fahrenheit", onChange: () => set("units", "fahrenheit") }),
        "\u534E\u6C0F \xB0F"
      ] })
    ] }) }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Row, { label: `\u5237\u65B0\u95F4\u9694\uFF08\u5206\u949F\uFF0C\u5F53\u524D ${effective.refreshMinutes}\uFF09`, labelFor: `${ids}-refresh`, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
      "input",
      {
        id: `${ids}-refresh`,
        type: "range",
...
function WeatherSettingsSection(props) {
  ...
  const [config, setConfig] = (0, import_react14.useState)(() => sanitizeConfig(scope.getSnapshot().value));
  ...
  const notify = (0, import_react14.useCallback)((text, kind = "ok") => {
    setNotice({ text, kind });
  }, []);
  ...
  const commit = (0, import_react14.useCallback)((fields, clears = []) => {
    ...
    return writeVerified(scope, rawFields, rawClears).then((accepted) => {
      ...
      return probe(rawFields, rawClears).then((result) => {
        if (result.ok) {
          setConfig(sanitizeConfig(result.value));
  ...
  const set = (0, import_react14.useCallback)((field, value) => {
    void commit([[field, value]]);
  }, [commit]);
  const savedCities = useSavedLocations({ scope, effective, onNotice: notify });
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { style: { maxWidth: 560, padding: "4px 0 20px", color: FG }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { fontSize: 15, fontWeight: 600, marginBottom: 4 }, children: "\u5929\u6C14" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { color: MUTED, fontSize: 12.5, marginBottom: 16 }, children: "\u4F1A\u8BDD\u9876\u90E8\u64CD\u4F5C\u884C\u7684\u5929\u6C14 chip\uFF08\u6570\u636E\u6765\u6E90\uFF1AOpen-Meteo\uFF0C\u65E0\u9700 API key\uFF09\u3002" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(UnitsSection, { effective, set }),
    notice !== null && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
      "div",
      {
        role: "status",
        "aria-live": "polite",
    ...
    snapshot.mode === "memory" && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { style: { color: MUTED, fontSize: 12.5, marginTop: 8 }, children: "\u5F53\u524D\u8FDE\u63A5\u4E3A\u8FDB\u7A0B\u5185\u6A21\u5F0F\uFF0C\u914D\u7F6E\u4EC5\u5728\u672C\u6B21\u4F1A\u8BDD\u751F\u6548\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(DiagnosticsSection, { effective, notify })
  ] });
}

// src/client/ui/styles.ts
var STYLE_TEXT = [
...
function createWriteProbe(ctx) {
  ...
  return async (fields, clears) => {
    ...
    if (settings === void 0) return { ok: false, detail: "remote.settings \u4E0D\u53EF\u7528" };
    const ops = [
    ...
    try {
      ...
      if (described.ok) {
        revision = (described.value.namespaces ?? []).find((row2) => row2.ns === WEATHER_NS)?.revision;
      }
    } catch {
      revision = void 0;
    }
