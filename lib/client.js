...
function rainSoonShortText(rain) {
  if (rain.rainingNow) return "\u6B63\u5728\u4E0B\u96E8";
  const onset = rain.onsetMinutes;
  if (onset === void 0 || onset > 120) return void 0;
...
function WeatherBar(props) {
  ...
  const rainShort = data?.rainSoon !== void 0 && !data.rainSoon.rainingNow ? rainSoonShortText(data.rainSoon) : void 0;
  const subText = status === "locating" ? "\u5B9A\u4F4D\u4E2D\u2026" : status === "loading" ? "\u52A0\u8F7D\u4E2D\u2026" : status === "error" ? "\u26A0 \u52A0\u8F7D\u5931\u8D25" : data !== null && condition !== null ? `${condition.label} \xB7 \u4F53\u611F ${fmt(data.current.apparentTemperature)}${rainShort !== void 0 ? ` \xB7 \u2614 ${rainShort}` : ""}` : "";
  const showTemp = status === "ready" && data !== null;
  const barIcon = status === "ready" && data !== null ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(WeatherIcon, { code: data.current.weatherCode, isDay: data.current.isDay, size: 20 }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Glyph, { name: "pin", size: 18 });
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { style: { display: "flex", flexDirection: "column", gap: 1, minWidth: 0, flex: "1 1 auto" }, children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: 13, fontWeight: 600, lineHeight: "17px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: name }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: 11.5, lineHeight: "15px", color: TOKEN.fgMuted, ...status === "error" ? { color: TOKEN.danger } : {} }, children: subText })
              ] }),
              ...
              showTemp && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { fontSize: 18, fontWeight: 700, lineHeight: "22px", ...NUM, flex: "0 0 auto" }, children: fmt(data.current.temperature) }),
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { flex: "0 0 auto", fontSize: 10, color: TOKEN.fgMuted, marginLeft: 2 }, children: open ? "\u25BE" : "\u25B8" })
            ]
          }
        ),
...
function WeatherSettingsSection(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { style: { maxWidth: 560, padding: "4px 0 20px", color: FG }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { style: { color: MUTED2, fontSize: 12.5, marginBottom: 16 }, children: "\u9876\u90E8\u5C45\u4E2D\u7684\u5929\u6C14\u680F\uFF08\u6570\u636E\u6765\u6E90\uFF1AOpen-Meteo\uFF0C\u65E0\u9700 API key\uFF09\u3002" }),
