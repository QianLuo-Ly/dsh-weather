...
var mapAir = (res) => {
  ...
  const raw = res.json;
  const aqi = raw?.current?.us_aqi ?? void 0;
  const pm25 = raw?.current?.pm2_5 ?? void 0;
  return aqi === void 0 && pm25 === void 0 ? void 0 : { aqi, pm25 };
};
...
var TITLE_PREFIX_RE = new RegExp(`^(?:${CONDITION_EMOJIS.join("|")}) \\S+ -?\\d+\xB0[CF] .+? \u2014 `);
...
function HourlyStrip(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { "data-block": "hourly", style: { marginTop: 10 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { display: "flex", gap: 6, overflowX: "auto", paddingBottom: 4 }, children: points.map((point) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { flex: "0 0 auto", width: 46, textAlign: "center", background: TOKEN.bgSoft, borderRadius: 10, padding: "5px 2px" }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { margin: "2px 0" }, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(WeatherIcon, { glyph: glyphForCode(point.weatherCode, point.isDay), size: 18 }) }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", gap: 6, overflowX: "auto", paddingBottom: 4, marginTop: 8 }, children: [
      ...
      detail.hourly.map((point) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontSize: 11, color: TOKEN.fgMuted, ...NUM }, children: hourLabel(point.time) }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { margin: "2px 0", minHeight: 18 }, children: point.weatherCode !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(WeatherIcon, { glyph: glyphForCode(point.weatherCode, point.isDay), size: 18 }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { fontSize: 12, color: TOKEN.fgMuted }, children: "\u2014" }) }),
