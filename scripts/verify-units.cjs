...
eq('severity: hail code over a Bft-12 gust is danger', X.severityOfCode(96, 0.8, 120), 'danger')
...
eq('alerts: a Bft-10 sustained wind is danger', [firstOf(sample({ windSpeed: 95 })).key, firstOf(sample({ windSpeed: 95 })).level], ['wind', 'danger'])
